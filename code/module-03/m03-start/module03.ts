...
function calculateConventionalLoanPayment(extendedLoan: ConventionalLoan):string {
    // Calculates the monthly payment of a conventional loan
    let interest = extendedLoan.interestRate / 1200; // Calculates the Monthly Interest Rate of the loan
    let payment;
